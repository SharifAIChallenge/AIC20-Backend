# Generated by Django 2.2.7 on 2019-12-06 08:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education', models.CharField(choices=[('HS', 'دبیرستان'), (' BR', 'کارشناسی'), ('MR', 'کارشناسی ارشد'), ('PHD', 'دکنری')], default='HS', max_length=3)),
