    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tags', to='apps.blog.Post')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='apps.blog.Post')),
                ('reply_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.blog.Comment')),
            ],
        ),
    ]
